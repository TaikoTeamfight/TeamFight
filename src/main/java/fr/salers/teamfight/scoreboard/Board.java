package fr.salers.teamfight.scoreboard;
...
public class Board
{
    ...
    private void init() {
        if (!this.player.getScoreboard().equals(TFight.INSTANCE.getPlugin().getServer().getScoreboardManager().getMainScoreboard())) {
            this.scoreboard = this.player.getScoreboard();
        }
        else {
            this.scoreboard = TFight.INSTANCE.getPlugin().getServer().getScoreboardManager().getNewScoreboard();
        }
