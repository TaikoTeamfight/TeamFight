 ...
 * <pre>
 * new ItemBuilder(Material.SPONGE).name("&emp;cAlmighty sponge").amount(21).build();
 * </pre>
 *
 * @author SamJakob
 * @version 2.0.0
...
public class ItemBuilder {
     ...
     * Color codes using the ampersand (&emp;) are translated, if you want to avoid this,
     ...
     * rather than their 'coded' form (&emp;).
     *
     * For example, if you used {@link #name(String)} to set the name to '&emp;cMy Item', the output of this
     ...
     * ifThen(stack -&gt; stack.getType() == Material.ACACIA_DOOR, stack -&gt; stack.name("&emp;aMagic Door"));
     * </pre>
     *
